...
<html>
  <head>
    <meta charset="UTF-8">
    <link rel="stylesheet" type="text/css" href="am-modulation.css">
    <title>AM Modulation (DSSC) Experiment</title>
  </head>
  <body>
    <div class="topnav">
      <a href="#home">Home</a>
    ...
    <h1>AM Modulation (DSSC) Experiment</h1>
    <p>Welcome to the AM Modulation (DSSC) Experiment page!</p>
    <p>Here, you will learn how to perform amplitude modulation using the Double Sideband Suppressed Carrier (DSSC) method.</p>
    <h2>Instructions</h2>
    <ol>
      <li>Connect the audio signal source to the modulator circuit.</li>
      <li>Connect the modulator circuit output to the DSSC circuit input.</li>
      <li>Connect the DSSC circuit output to the antenna or an oscilloscope.</li>
      <li>Adjust the modulator and DSSC circuits as needed to achieve the desired modulation level and frequency.</li>
